...
ALTER TABLE "account" DROP CONSTRAINT "accounts_user_id_user _id_fk";
...
ALTER TABLE "account" ADD CONSTRAINT "account_user_id_user _id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user "("id") ON DELETE cascade ON UPDATE no action;